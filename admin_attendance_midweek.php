...
if($results2 = mysqli_query($db,"SELECT DISTINCT Date FROM weekday_attendance ORDER BY Date DESC")){
...
<div data-role="page" id="thankucard" data-theme="d">
    ...
    foreach($records2 as $r2){ 
       ...
       print("<ul data-role=\"listview\" data-inset=\"true\">");
                            ...
                            print("<a data-ajax=\"false\" data-transition=\"pop\"href=\"admin_attendance_repmidweek.php?action=".($column)."&activity=thanksyou\">");                           
                            print("".($column)."<br/>");
                            print("</a>");
                            print("</li>\n");  
