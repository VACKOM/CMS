...
if($results = mysqli_query($db,"SELECT * FROM weekday_attendance")){
...
if($chapelCode == "JOHN/" && $Date == $SelectedDate){
    ...
    else if($chapelCode == "EXODU" && $Date == $SelectedDate){
     $Exodus++;
     $counting++;
...
<div data-role="page" id="schedule" data-theme="d" >
    <div data-role="header" data-theme="d" >
         <h4>Mid Week Service <?php echo ($SelectedDate); ?> </h4>
...
if($results4 = mysqli_query($db,"SELECT * FROM weekday_attendance")){
